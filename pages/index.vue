      ...
      <div class="flex md:flex-row flex-col">
        <div class="w-1/2 flex flex-col justify-center items-center w-full">
          <img
            ...
            "
            :src="require(`~/assets/index/pat_kitchen.jpg`)"
          />
          <p class="text-2xl">This is me (Pat)</p>
        </div>
        <div class="w-1/2 flex flex-col justify-center items-center w-full">
          <img
            class="
              ...
              hover:-translate-y-1 hover:scale-105
            "
            :src="require(`~/assets/index/pepper_assistant.jpg`)"
          />
      ...
      script: [
        {
          json: {
            ...
            image: `https://food.pat-lego.com${require("~/assets/index/food/20210824_193539.resize.jpg")}`,
            thumbnail: `https://food.pat-lego.com${require("~/assets/index/food/20210824_193539.resize.jpg")}`,
